				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
								We meticulously select the best ingredients to create extraordinary dishes that tantalize your taste buds. Prepare for a gastronomic journey like no other. Satisfaction guaranteed.
	                        </p>
	                    </div>
	                </div>
				</div>
				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
								Nourishing body and soul with wholesome ingredients. Crafting culinary delights that inspire joy and ignite passion on every plate.
	                        </p>
	                    </div>
	                </div>
				</div>
				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
								Exceeding expectations with impeccable service. Our dedicated team strives to create memorable experiences, ensuring every guest feels valued and pampered from start to finish.
	                        </p>
	                    </div>
	                </div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
						...
						<p>
                        Welcome to our esteemed restaurant, where culinary excellence meets unparalleled taste. We take immense pride in offering a delectable menu filled with mouthwatering dishes that will tantalize your palate. Our team of talented chefs meticulously crafts each dish, using the finest and freshest ingredients to ensure an unforgettable dining experience.<br>

From savory appetizers to succulent mains and irresistible desserts, our menu boasts a diverse selection that caters to various preferences and dietary needs. Whether you crave traditional favorites or adventurous creations, our culinary offerings are designed to satisfy every craving.    
						</p>
                        <h3>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <ul class="opening_time">
                            <li>Monday - Friday 11:30am - 02:00am</li>
                            <li>Monday - Friday 11:30am - 02:00am</li>
                            <li>Monday - Friday 11:30am - 02:00am</li>
                            <li>Monday - Friday 11:30am - 02:00am</li>
                        </ul>
